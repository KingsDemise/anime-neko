...
const ParentComponent = () => {
  ...
  const { addToWatchlist, removeFromWatchlist, watchlist } = useContext(AppContext);
...
<Grid verticalAlign="middle" textAlign="center" columns={'equal'} >
          <Grid.Column>
          <Image style={{padding:"10px"}} verticalAlign="middle" src="https://rb.gy/ek868" circular size='small'/>
