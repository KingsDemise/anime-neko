...
const Watchlist = () => {
  ...
  return (
    <Grid verticalAlign="middle" textAlign="center" columns={'equal'} padded className='grid'>
      <Grid.Column>
      <h2 style={{ fontSize: '50px'}}>My Watchlist</h2>
<Link to="/" style={{ fontSize: '20px'}}><Icon name='search'/>Back to Home</Link>
<div>
{isEnmpty? (
  <Grid.Column><h2 style={{ fontSize: '15px',fontFamily: "Helvetica, sans-serif", fontStyle:"italic",padding:"10px"}}>Quiet here, start adding some animes......</h2>
  </Grid.Column>
  ):(
